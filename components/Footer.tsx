          ...
          <div id="faq">
            ...
            <div className="mt-3 flex flex-col gap-2 text-sm leading-relaxed text-white/60">
              <a
                ...
                className="inline-flex w-fit items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 font-semibold text-white transition-colors hover:bg-[#20bd5a]"
              >
                <svg
              ...
              <p>Phone: 01777548390</p>
              <p>Email: rookiesdnmco@gmail.com</p>
