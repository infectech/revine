...
export const metadata = {
  ...
  description:
    "Frequently asked questions about returns, exchanges, and delivery.",
};
    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-6">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span>📦</span>
                  <span>
                    Please check your parcel in front of the delivery person
                    before accepting it.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span>❌</span>
                  <span>
                    No return is possible after the delivery person leaves.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span>🔄</span>
                  <span>
                    Exchange is available within 10 days for any reason.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span>🚚</span>
                  <span>
                    If the exchange is due to a size issue, change of mind, or
                    any reason not caused by {SITE_CONFIG.name}, applicable
                    delivery/courier charges will be paid by the customer.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span>❤️</span>
                  <span>
                    If the issue is due to wrong product, manufacturing defect,
                    or any mistake from {SITE_CONFIG.name}, we'll cover the
                    exchange delivery charge.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="rounded-3xl border border-black/5 bg-white p-6 sm:p-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            If you have any questions about returns, exchanges, or your order,
